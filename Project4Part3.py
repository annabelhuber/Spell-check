...
# begin = time.time()
# print(edit_dist_recursive("analysis", "algorithms"))
# end = time.time()

#print("recursive time:", end-begin)
...
#to test the spells check on Project 4, uncomment the lines below
